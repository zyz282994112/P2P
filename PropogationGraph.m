classdef PropogationGraph < Classifier
   %%Ming Ji 论文方法实现
    properties  %%定义类变量
        lamada;
        afa;
    ...
    methods   %定义类方法   
        ...
        function obj = PropogationGraph(DataLabel,DataFeature,DataMatrix)
           obj=obj@Classifier(DataLabel,DataFeature,DataMatrix);
        end
        
        function Run(obj,TrainTag,TestTag,m)
            trainlabel=obj.DataLabel{m}(TrainTag,:);
            testlabel=obj.DataLabel{m}(TestTag,:);
